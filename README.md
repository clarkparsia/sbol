...
SBOL Designer can be used either as a standlone program or a as a [Geneious] plugin.
...
command at a terminal where '<jarFileName>' wil lbe the name of the SBOL Designer jar file you
downloaded.
